        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center lg:items-start">
          ...
          <div className="order-1 lg:order-2 flex flex-col gap-12">
            <div className="flex flex-col gap-2">
              ...
              className=" text-4xl lg:text-4xl text-center lg:text-left font-medium text-[#1E73B9] "> 
                {getTitle} 
              </motion.h2>
              <motion.div 
                            initial={{ y: 100, opacity: 0 }}
              ...
              className=" w-20 px-4 py-[2px] bg-[#FAB613]">
              </motion.div>
            </div>
            ...
            >
              <Link href="/about" className="bg-[#FAB613] hover:bg-[#D89A1E] px-8 py-4 rounded-lg text-white cursor-pointer flex items-center gap-2">
