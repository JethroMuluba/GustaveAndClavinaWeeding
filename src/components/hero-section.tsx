...
import cover01 from "@/public/Asset_01.webp"
...
export default function  HeroSection() {
  ...
  return (
    <motion.section 
      ...
      className="bg-fixed bg-[#1E73B9] overflow-hidden flex justify-between items-center h-[600px] lg:h-full  lg:pl-15 "
    ...
    >
      ...
      >
        ...
        <Link href="/services" className="bg-[#FAB613] hover:bg-[#D89A1E] px-8 py-4 rounded-lg font-normal text-white cursor-pointer self-center lg:self-start flex items-center gap-2 ">
          <span>DÉCOUVRIR</span>
